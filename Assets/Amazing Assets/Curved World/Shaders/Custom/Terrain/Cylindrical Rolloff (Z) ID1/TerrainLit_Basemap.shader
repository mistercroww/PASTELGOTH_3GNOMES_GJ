Shader "Hidden/Amazing Assets/Curved World/TerrainLit/Cylindrical Rolloff (Z) ID 1/Basemap"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        UsePass "Amazing Assets/Curved World/TerrainLit/Cylindrical Rolloff (Z) ID 1/SceneSelectionPass"
    }
}

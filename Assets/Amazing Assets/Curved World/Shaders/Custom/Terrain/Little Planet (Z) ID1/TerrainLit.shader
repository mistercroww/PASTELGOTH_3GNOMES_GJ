Shader "Amazing Assets/Curved World/TerrainLit/Little Planet (Z) ID 1"
{
    Properties
    {
        [HideInInspector][CurvedWorldBendSettingsTerrain] _CurvedWorldBendSettings("6|1", vector) = (0, 0, 0, 0)
    ...
    #define CURVEDWORLD_BEND_TYPE_LITTLEPLANET_Z
    ...
    Dependency "BaseMapShader" = "Hidden/Amazing Assets/Curved World/TerrainLit/Little Planet (Z) ID 1/Basemap"

Shader "Hidden/Amazing Assets/Curved World/TerrainLit/Classic Runner (X Positive) ID 1/Basemap"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        UsePass "Amazing Assets/Curved World/TerrainLit/Classic Runner (X Positive) ID 1/SceneSelectionPass"
    }
}

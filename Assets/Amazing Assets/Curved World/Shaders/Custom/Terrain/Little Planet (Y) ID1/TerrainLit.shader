Shader "Amazing Assets/Curved World/TerrainLit/Little Planet (Y) ID 1"
{
    Properties
    {
    ...
    Dependency "BaseMapShader" = "Hidden/Amazing Assets/Curved World/TerrainLit/Little Planet (Y) ID 1/Basemap"

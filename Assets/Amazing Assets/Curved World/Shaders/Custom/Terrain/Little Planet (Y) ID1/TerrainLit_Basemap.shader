Shader "Hidden/Amazing Assets/Curved World/TerrainLit/Little Planet (Y) ID 1/Basemap"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        UsePass "Amazing Assets/Curved World/TerrainLit/Little Planet (Y) ID 1/SceneSelectionPass"
    }
}

Shader "Amazing Assets/Curved World/TerrainLit/Cylindrical Rolloff (Z) ID 1"
{
    Properties
    {
        [HideInInspector][CurvedWorldBendSettingsTerrain] _CurvedWorldBendSettings("10|1", vector) = (0, 0, 0, 0)
    ...
    #define CURVEDWORLD_BEND_TYPE_CYLINDRICALROLLOFF_Z
    ...
    Dependency "BaseMapShader" = "Hidden/Amazing Assets/Curved World/TerrainLit/Cylindrical Rolloff (Z) ID 1/Basemap"

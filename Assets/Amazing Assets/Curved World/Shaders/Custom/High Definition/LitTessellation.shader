Shader "Amazing Assets/Curved World/LitTessellation"
{
    Properties
    {
...
#include "../../Core/CurvedWorldTransform.cginc"
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            #include "LitSharePass.hlsl"
            #else
            #include "LitMotionVectorPass.hlsl"
            #endif
            #include "Packages/com.unity.render-pipelines.high-definition/Runtime/Material/Lit/LitData.hlsl"
        ...
        Pass
        {
            ...
            #include "Packages/com.unity.render-pipelines.high-definition/Runtime/Material/Material.hlsl"
            #include "Packages/com.unity.render-pipelines.high-definition/Runtime/Material/Lit/Lit.hlsl"
            #include "LitConstantPass.hlsl"
            #include "Packages/com.unity.render-pipelines.high-definition/Runtime/Material/Lit/LitData.hlsl"
            #include "ShaderPassConstant.hlsl"
        ...
        Pass
        {
            ...
            #include "LitSharePass.hlsl"
            #include "Packages/com.unity.render-pipelines.high-definition/Runtime/Material/Lit/LitData.hlsl"
            #include "ShaderPassFullScreenDebug.hlsl"
    ...
    CustomEditor "Rendering.HighDefinition.CurvedWorldLitGUI"
}

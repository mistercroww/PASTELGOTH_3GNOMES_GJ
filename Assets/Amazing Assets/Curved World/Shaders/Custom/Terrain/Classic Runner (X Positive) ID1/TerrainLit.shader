Shader "Amazing Assets/Curved World/TerrainLit/Classic Runner (X Positive) ID 1"
{
    Properties
    {
        [HideInInspector][CurvedWorldBendSettingsTerrain] _CurvedWorldBendSettings("0|1", vector) = (0, 0, 0, 0)
    ...
    Dependency "BaseMapShader" = "Hidden/Amazing Assets/Curved World/TerrainLit/Classic Runner (X Positive) ID 1/Basemap"
